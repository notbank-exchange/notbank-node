...
var _HttpConnection_jsonRequester, _HttpConnection_formDataRequester, _HttpConnection_host;
...
export class HttpConnection {
    constructor(domain) {
        ...
        _HttpConnection_formDataRequester.set(this, void 0);
        _HttpConnection_host.set(this, void 0);
        __classPrivateFieldSet(this, _HttpConnection_jsonRequester, new JsonRequester(), "f");
        __classPrivateFieldSet(this, _HttpConnection_formDataRequester, new FormDataRequester(), "f");
    ...
    nbRequest(endpoint_1, requestType_1, message_1) {
        return __awaiter(this, arguments, void 0, function* (endpoint, requestType, message, paged = false) {
            ...
            var response = yield __classPrivateFieldGet(this, _HttpConnection_jsonRequester, "f").request({ url, requestType, params: message });
    ...
    apRequest(endpoint, requestType, message, extraHeaders) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var response = yield __classPrivateFieldGet(this, _HttpConnection_jsonRequester, "f").request({
                url,
                requestType,
                params: message,
                extraHeaders
    ...
    updateSessionToken(sessionToken) {
        __classPrivateFieldGet(this, _HttpConnection_jsonRequester, "f").updateSessionToken(sessionToken);
    }
    authenticateUser(params) {
        return __awaiter(this, void 0, void 0, function* () {
            var response = yield this.apRequest(Endpoint.AUTHENTICATE_USER, RequestType.GET, null, params);
            __classPrivateFieldGet(this, _HttpConnection_jsonRequester, "f").updateSessionToken(response.SessionToken);
        });
    }
...
_HttpConnection_jsonRequester = new WeakMap(), _HttpConnection_formDataRequester = new WeakMap(), _HttpConnection_host = new WeakMap();
